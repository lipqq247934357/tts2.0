...
// // }
// //
// // TT.formatBigInt = function(timestamp) {
// //     timestamp += "";
// //     var aa = "year_4,month_2,day_2,hours_2,minutes_2,seconds_2,microseconds_3";
// //     var bb = [];
// //     var s = 0;
// //     for (var i = 0; i < aa.split(",").length; i++) {
// //         var tt = aa.split(",")[i].split("_");
// //         bb[tt[0]] = timestamp.substr(s, parseInt(tt[1]));
// //         s += parseInt(tt[1]);
// //     }
// //     return bb['year']+'-'+bb['month']+'-'+bb['day']+' '+bb['hours']+':'+bb['minutes']+':'+bb['seconds'];
// // }
//
// // TT.preMonth = function(date){
// //     var nddate = new Date(date);
// //     var y = nddate.getFullYear();
// //     var m = nddate.getMonth();
// //     var d = nddate.getDate();
// //     var ny, nm, nd;
// //
// //     // 月份
// //     if (m == 1) {
...
//  * @return
//  */
// let upperAmount = function (num:string) {
//     var strOutput = "";
...
//     };
//     var real = 0;
//     var max = obj.max > 0 ? (obj.remainder > obj.max ? obj.max
//         : obj.remainder) : obj.remainder;
//     maxA = max > obj.limit ? obj.limit : max;
//     var min = obj.min > 0 ? (obj.remainder < obj.min ? obj.remainder
//         : obj.min)
//         : 0;
//     if (obj.avaliable >= maxA) {
//         real = maxA;
//     }
//     if (obj.avaliable < maxA && obj.avaliable >= min) {
//         real = obj.avaliable;
//     }
//     return real;
// }
...
//
//         //月收益
//         var monthAmount = obj.amount * obj.dbdx_monthYield;
//         var beginDate = Date.parseBigInt(obj.dbdx_endtime);
//         var startDate = Date.parseBigInt(obj.dbdx_stime);
//
//         for (var i = 1; i <= obj.dbdx_term; i++) {
//             beginDate = TT.preMonth(beginDate);
//             if (new Date(beginDate) > new Date(startDate)) {
//                 amount += monthAmount;
//             } else {
//                 var nextDay = TT.nextMonth(beginDate);
//                 //把相差的毫秒数转换为天数
//                 var allDays = parseInt(new Date(nextDay) - new Date(beginDate) / 1000 / 60 / 60 / 24);
//                 if (allDays > 0) {
//                     var dayDiff = parseInt(new Date(nextDay) - new Date(startDate) / 1000 / 60 / 60 / 24);
//                     if (dayDiff > 0) {
//                         amount += monthAmount * dayDiff / allDays;
//                     }
//                 }
//             }
//         }
//         // 总收益
//         r.totalInt = amount.toFixed(2);
//         return r;
//     },
//     一次性还款: function (obj) {
//         var r = {};
...
// }
//
// TT.getUrlRelativePath = function () {
...
//     return relUrl;
// }
// TT.getDomain = function () {
//     var url = document.location.toString();
//     var arrUrl = url.split("/");
//
//     var domain = arrUrl[0] + "//" + arrUrl[2] + "/";
//
//     return domain;
// }
